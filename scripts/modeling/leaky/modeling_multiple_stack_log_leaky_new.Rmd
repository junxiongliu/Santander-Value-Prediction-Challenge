...
train_for_ens2 <- train_for_ens %>% mutate(row_num = row_number())
```
...
## write out
```{r}
write.csv(final_out, "../../../data/predictions/lk_predictions/lk_trainwhole_top200rfxgb_7ens_notoverfit.csv",
          row.names = FALSE)
```
