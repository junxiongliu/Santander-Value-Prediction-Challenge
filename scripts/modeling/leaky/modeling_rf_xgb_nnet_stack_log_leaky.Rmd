...
#### top 50rf features give ~0.82 test rmse
...
xgb_best_ens_r1 <- my_xgb(dtrain_ens_r1, depth = 100000, lr = 0.03, es = 10) 
...
## write out
```{r}
write.csv(final_out, "../../../data/predictions/lk_predictions/lk_trainwhole_top100rf_rfxgbens_fullTuned.csv", 
          row.names = FALSE)
```
