...
xgb_best_ens_r1 <- my_xgb(dtrain_ens_r1, depth = 100000, lr = 0.001, es = 5) # will need a super deep tree to accomodate small learning rate (i.e. 0.001) -- currently: 0.82 test rmse with lr=0.03 -- able to converge within 2500
